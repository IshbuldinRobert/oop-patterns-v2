...
public class Facade {
    public static <T extends Comparable<T>> int binarySearch(T[] array, T value, int min, int max) {
        int mid;
        if (min > max) {
            return -1;
        } else {
    ...
    public static <T extends Comparable<T>> void sort(T[] array, int startIndex, int endIndex) {
